...
if (isset($_POST['username'])){
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `dusers` WHERE dusername='$username'
...
<br/>Click here to <a href='dlogin.php'>Login</a></div>";
	}
    }else{
?>
    <div>
    ...
    x.type = "password";
              ...
              <div class="separator">
                <p class="change_link">New to site?
                  <a href="dsignup.php" class="to_register"> Create Account</a>
               ...
               <a href="http://localhost/food/home">   <h1></i>Home</h1></a>
				     ...
				     <div>
                           <a href="http://localhost/food/production/forgot2.php">   <h1></i>Forgot Password</h1></a>
