...
<html lang="en">
  ...
  error_reporting(0);
    ...
    if (isset($_REQUEST['username'])){
		...
		$trn_date = date("Y-m-d H:i:s");
		 ...
		 $query = mysqli_query($con, "SELECT * FROM dusers WHERE dusername = '".$username. "'");
 ...
 echo "<div class='form'><h3>!!!!!!!!!!! Please check your username</h3><br/>Click here to try again <a href='ufgp.php'>Update password</a></div>";
        ...
        if($result){
            ...
            echo "<div class='form'><h3>password updates successfully</h3><br/>Click here to <a href='dlogin.php'>Login</a></div>";
