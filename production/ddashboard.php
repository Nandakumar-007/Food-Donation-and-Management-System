              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="http://localhost/food/home"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="updatestatus.php" method="post"">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  name="username" readonly value="<?php echo $data['dusername']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="fname"  value="<?php echo $data['fullname']; ?>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email"  name="email" value="<?php echo $data['email']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel"  name="number" minlength="10" maxlength="10" value="<?php echo $data['phone']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<select  class="form-control col-md-7 col-xs-12" name="address"value="">
<option value="Select-area"><?php echo $data['address']; ?></option>
...
<option value="sidartha LAYOUT">sidartha LAYOUT</option>
...
<option value="Engage"> Engage</option>		</select>				
                            </div>
                      </div>
