...
where complaint.username='$a' AND status.status='accepted'";
...
<input type='hidden' name='dotp' value="<?php echo $data['otp']; ?>" readonly/>
Enter OTP : <input type='text' name='rotp' require/>

          <label for="status">Select Status:</label>
    <select id="status" name="status" require>
