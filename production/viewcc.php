...
?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
				  <h1> Name : <?php echo $data['zone']; ?> </h1>
                    <h3>Size : <?php echo $data['ss']; ?><br>
					 Address  : <a href="https://www.google.com/maps/place/<?php echo $data['address']; ?>" > <button type="submit" class="btn btn-success">Direction</button> </a></h3>
