...
if (isset($_REQUEST['username'])){
	...
	$trn_date = date("Y-m-d H:i:s");
        $query = "INSERT into `users` (username,fullname,email,phone,address, password, trn_date)
VALUES ('$username','$fname','$email','$pno', '$address', '".md5($password)."', '$trn_date')";
...
<script>
  ...
  usernameInput.addEventListener('input', function() {
    ...
    if (!regex.test(username)) {
      ...
      document.getElementById('usernameError').textContent = '';
			  ...
			  <div>
                <input type="text" name="fname"class="form-control" placeholder="Full name" autocomplete="none" required="" />
  ...
  fullNameInput.addEventListener('input', function() {
    ...
    if (!regex.test(fullName)) {
      document.getElementById('nameError').textContent = 'Please enter alphabets only.';
    } else {
      document.getElementById('nameError').textContent = '';
			   ...
			   <div>
                <input type="tel" name="pno" minlength="10" maxlength="10" pattern="[0-9]{10}" class="form-control" placeholder="Phone Number" required="" />
              </div>
			  <br>
              <div>
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Online Food Wastage Reduction System</h1>
                  <p></p>
                </div>
              </div>
            </form>
