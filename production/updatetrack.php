...
<html lang="en">
 ...
 error_reporting(0);
	 $a=$_SESSION['username'];
	 $query="SELECT * from dusers where dusername = 'M101'";
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>Pick-up-Deliver </span></a>
            </div>
          ...
          <div class="profile clearfix">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				  ...
				  <li><a><i class="fa fa-bar-chart-o"></i> View Complaint Details </span></a>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>UPDATE STATUS INFORMATION <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask"  action="trackdb.php" method="post"">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">DELIVER MEMBER ID</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" name="p5"  placeholder="DELIVER MEMBER ID">
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Status</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="p6" class="form-control col-md-7 col-xs-12"  >
                            ...
                            <option value="Successfully Pick-Up">Successfully Pick-Up</option>
					   ...
					   <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">DELIVER TIME</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="TIME" name="p7"  class="form-control" >
                        </div>
                      </div>
					                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">EXPECTED DELIVERY DATE </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
