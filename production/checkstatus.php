...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
	 ...
	 error_reporting(0);
	  $a=$_SESSION['username'];
      $query=("SELECT * from status where wid='$a'");
...
<small>Massage : <?php echo $data['mes']; ?></small><br>
<a href="https://www.google.com/maps/search/<?php echo $data['address']; ?>" target="_blank"><i class="fas fa-map-marker-alt"></i> Direction </a></br>

<h3>
    <?php if (!empty($data['otp'])) { ?>
        <small>OTP: <?php echo $data['otp']; ?></small>
    <?php } else { ?>
        <small>OTP is not yet received</small>
    <?php } ?>
</h3>
